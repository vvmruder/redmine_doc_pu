...
Now the plugin is ready to go for publishing documents. This plugin is intended to be used in project scope. So you can have generated documents per project => wiki. If you have enbled the module in a project you get a new __publish__ tab. Here you have a list of all your created documents and you can start the creating process itself. Once you created a new document (fill in all data and check all items you want to be used for this document) you get a new view. In this you can add wiki pages (only from this project) to the document (please note that the order in the list of wiki pages is the order in the document).
